...
namespace Gateway.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var getUsernames = $"{_authApiBaseUrl}/api/Users/usernames";
            try
            {
                /*
                ...
                */
                ...
                var response = await _httpClient.GetAsync(getUsernames);
                ...
                try
                {
                    apiResponse = JsonSerializer.Deserialize<List<string>>(productsJson, new JsonSerializerOptions
                    {
