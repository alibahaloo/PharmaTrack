...
var authUrl = builder.Configuration["ApiUrls:Auth"];
if (string.IsNullOrWhiteSpace(authUrl))
{
    throw new InvalidOperationException(
        "Missing configuration value 'ApiUrls:Auth' (under ApiUrls in appsettings.json).");
}
...
// 3) typed HttpClient for AuthService
builder.Services
